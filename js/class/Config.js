   ...
   class Config {
      constructor() {
         ...
         if (this.isHasSavedData()){
            ...
            let initChapterAmount = Math.ceil(500 / 50)      // 计算初始段数，非整数时向上取值
            ...
            this.darkMode             = true;                   // 暗黑模式
            this.articleType          = ArticleType.character;  // 文章类型
            this.IDBIndex             = 1;                      // IndexDB    序号
            // v2.1 自动发文
            this.isAutoNext           = true;                   // 自动发文
            this.isAutoRepeat         = true;                   // 重复发文
            this.isShuffleRepeat      = true;                   // 重复发文时乱序
            this.repeatCountTotal     = 5;                      // 总重复数
