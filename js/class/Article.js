...
define([
   ...
   return {
      errab: {
         ...
         content: '两之传使其命场士她子干怎想感望期格热着等紧被觉进',
      },
      top500: {
         name: '常用前500',
         value: 'top500',
         ...
         content: '还很由被部今西场该或命感保望传觉她士期领青落怎影早备格拉整石紧约英乎留称品志低念刻势曾须显热市久费父'
      },
      mid500: {
         name: '常用中500',
         value: 'mid500',
      ...
      tail500: {
         ...
         content: '鼓偏弱敌宽抽忍折献洗挂童尊乃塞佳洞淡盛雅革累载猛构杜庆抗针徒圆闪额奶赛协叹愈旅享偷寒丰辈颜赞库川辞型贝票拜审悲柔减伟振央予孤宋幕犹摸夺昨哭貌申岸赏版凭宇肩递燕郎遭呀季企壁惜婆朗零辛忆舒凤灭韩灰旦孟俗胸仲冬餐尖佩垂跃港骗融撞塔紫敏赖允粗刑扑岛臣琴域冠豪呆悄剩督召宾甘吐幅违臂辟逼竞邻池漫恨碎晨罚伍宿泉井繁匹尘辉魔仰盗勤搭挺幽荒恰废掩灾肃磨析泥拾凉麦隆耐播墨惑飘毁斜赤慰尉饰羊'
      },
      oneab: {
         name: '一简',
         value: 'oneab',
      ...
      twoab: {
         ...
         value: 'twoab',
         type: ArticleType.character,
         content: '定燕烟科晚春餐普参与怀宁呀道平离季洋放级诉保审实然站变宾占怪胆胸尖承绿志夺睡昨后悄隐列防低基原社际景铁充顺笔空肯卫限财菜率避秘降慢职杂屯划杨妻吸吉检攻厅睛朱增互弱宽冰抽折淡累载构针客闻婚库孤忍换陈良怕药争渐暗伯批珠协丰粗恨晨罚粉恰灾毁'
      },
      twore: {
         name: '二重',
         value: 'twore',
      ...
      threeab: {
         ...
         value: 'threeab',
         type: ArticleType.character,
         content: '利孩刻壮讨状油待仅论乘乖秉迫妙苦朗访付艺私异拍照齐雷松烈庄甲住敌皇杜闲仿亡予寻肖草艺齐兄牛遍泪叹页冬扎'
      },
      threere: {
         name: '三重',
         value: 'threere',
         type: ArticleType.character,
      content: '热街怎够卷使传挂佳庭尤剩竞寸繁俗竞',
      },
      fourfull: {
         name: '四全',
         value: 'fourfull',
         type: ArticleType.character,
         content: '惊欲场犹仲港塔遭监恐靠探石领堂摸貌冷值脚围尚哭郎游该登射肩冠豪域摩刑督票柔察堂船掌恶救登探含牌监判鼓资霞甜贵靠扁命偏童猛抗徒圆赛愈旅辈颜川辞型摸救翻篇岸零韩跃违邻漫宿辉仰荒掩警君港佳',
      },
      fourre: {
         name: '四重',
         value: 'fourre',
