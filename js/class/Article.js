...
define([
   ...
   return {
      top500: {
         ...
         content: '都其两文想使被你常解便教命象传干花满觉士死领随落怎技拉照石推留严热'
      },
      mid500: {
         name: '常用中500',
         value: 'mid500',
         ...
         content: '查般斯倒突号树拿克初广奇愿欢希母香破谁致线急古既京甚晚争游龙余护另器木苦孩试朝阿队居害独讲错局男差社换够诉资密案史较环投静宝专修室区料帮衣竟模脸善兵考规联团冷玉施派顾春责夜画惊银负续吗简章左块索酒值态按陈河巴冲阵境助角户乱呼灵脚继楼景怕停铁异谢否伤兰置医良承福科属围需退基右速适药怀击买素背岁土忙充排价质遇端列印贵疑露哥杀标招血礼弟亮齐穿脑委州某顺省讨尚维板散项状追笔副层沙养读习永草胡济执察归富座雨堂威忽苏船罪敢妇村著食导免温莫掌激慢托胜险寻守波雷沉秀职验靠楚略族藏丽渐仅肯担扬盘唐钟级毛营坚松皮供店饭范哈赶吧雪斗效临农味恶烟园烈配杂短卫跳孙曲封抓移顿律卖艺旧朋救防脱翻划迎痛校窗宣乡杨叶警限湖软掉财词压挥超屋秋跑忘馆暗班党宗坏技困登姐预耳席梦朱组旁份禁套亚益探康增诗戏伯晓含劳恩顶君庄谓付田毕纸研虚怪宁替犯灯优您姓例丝盖误架幸隐股毒娘占智佛床米凡介征彩演射祖欲束获舞圣伙梅普借私源镇睡缓升纳织歌宫概野醒夏互积街牌休摇洋败监骨批兄刀网率庭熟创访硬仁菜丁绿牛避阴拍雄秘缺卷姑尼油恐玩释遍握球降虑荣策肉妈迷检伸欧攻练育危厅啊睛摆茶勇判材抱亦妻吸喝趣嘴逐操午吉浪轮默毫冰珠'
      },
      tail500: {
         name: '常用后500',
         value: 'tail500',
      ...
      fourfull: {
         ...
         value: 'fourfull',
         type: ArticleType.character,
         content: '惊资满建欲单镇场该犹市仲甲港塔遭监恐靠探石告士领照摸貌督冷值脚围尚追哭郎游该登射肩速冠喊豪彻域摩刑督票柔察堂船掌赶恶救翻登探含牌监判鼓',
      },
      fourre: {
         name: '四重',
         value: 'fourre',
         type: ArticleType.character,
         content: '雨推敏养赖推命致疑露警庭默凭赏惜',
      },
      phrase: {
         name: '常用词条',
         value: 'phrase',
